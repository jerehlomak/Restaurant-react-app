  ...
  <div className='app__footer section__padding'>
    ...
    <div className='app__footer-links'>
      <div className="app__footer-links_contact">
        ...
        <p className='p__opensans'>No. 28 Old Airport Netaccess</p>
        <p className='p__opensans'>+234 039 284 8302</p>
        <p className='p__opensans'>+233 473 383 3930</p>
      </div>
    ...
    <div className='footer__copyright'>
      <p className="p__opensans">&copy; 2021. All Rights reserved</p>
    </div>
  </div>
);
